...
public class Client
{
	...
	public void receiveMessages()
	{
		new Thread(new Runnable(){
			public void run(){
				...
				gui.appendMessage("Verbindung zum Server verloren.");
			}
		}).start();
	}
	...
	public void query(String cmd) throws NumberFormatException, IOException
	{
		...
		{
			gui.showErrorMessage("Unbekanntes Kommando", "Folgendes Kommando wurde empfangen: " + cmd);
		}
	}
	...
	public void endGame(String result)
	{
		if(result != null)
		{
			gui.appendMessage("Glückwunsch! Sie haben gewonnen.");
		}
